"""Run generation 2 of the deterministic Eureka-style reward search.
...
CANDIDATES = [
    {
        ...
        "best_progress_reward_scale": 20.0,
        "progress_goal_bonus_scale": 5.0,
        "progress_target_deg": 45.0,
        "entropy_coef": 0.001,
    },
    {
        "name": "progress_dense_45",
        "spin_reward_scale": 0.0,
        "best_progress_reward_scale": 40.0,
        "progress_goal_bonus_scale": 10.0,
        "progress_target_deg": 45.0,
        "entropy_coef": 0.002,
    },
    {
        "name": "progress_90",
        "spin_reward_scale": 1.0,
        "best_progress_reward_scale": 30.0,
        "progress_goal_bonus_scale": 8.0,
        "progress_target_deg": 90.0,
        "entropy_coef": 0.001,
    },
]
...
def main() -> int:
    ...
    plan = {
        ...
        "reflection": "generation 1 raised instantaneous reward but produced zero net rotation; "
                      "generation 2 rewards only new cumulative heading maxima",
    ...
    for candidate in CANDIDATES:
        ...
        try:
            ...
            result.update(
                ...
                quarter_turn_rate=mean("quarter_turn_rate"),
                half_turn_rate=mean("half_turn_rate"),
                projected_turns=mean("projected_turns_mean"),
    ...
    ranking = sorted(
        complete,
        key=lambda result: (
            result["success_rate"], result["started_rate"], result["half_turn_rate"],
            result["quarter_turn_rate"], result["projected_turns"], -result["drop_rate"],
        ),
        reverse=True,
    )
    summary = {
