"""Convert assets/xarm5_dh116/xarm5_dh116.urdf to USD with the Isaac Sim 6.0 importer.

    conda run --no-capture-output -n isaacsim python scripts/xarm5_dh116/convert_assets.py

Writes assets/xarm5_dh116/usd_manual_2026_04/xarm5_dh116/xarm5_dh116.usda (layered payloads
...
URDF = ASSET_DIR / "xarm5_dh116.urdf"
...
def main() -> int:
    ...
    cfg = URDFImporterConfig(
        ...
        override_joint_stiffness={ARM: 400.0, HAND_ACTIVE: 1.0, HAND_PASSIVE: 0.0},
        override_joint_damping={ARM: 40.0, HAND_ACTIVE: 0.1, HAND_PASSIVE: 0.0},
    )
    t0 = time.time()
